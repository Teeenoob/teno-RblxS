...
local textBox = Instance.new("TextLabel", surfaceGui)
textBox.Text = ""
...
function input (str)
	...
	elseif space[1]:lower() == "pitch" then
		output.Text ..= "\n>" .. str
...
local sTextBox = surfaceGui:WaitForChild"TextLabel"
